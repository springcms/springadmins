...
@section('content_header')
    ...
    @include('springadmins::admin.menussystem.partials.search')
                          ...
                          <td>
                               <div class="btn-group">
                                  <a href="#modal-delete" class="btn btn-default btn-sm" 
                                    ...
                                    data-deleteurl="{{route('menus-system.destroy', ['menu' => $menu->id])}}" 
                                    data-name="{{$menu->name}}" ><i class="fa fa-trash-o"></i></a>
                                  <a href="#modal-edit" class="btn btn-default btn-sm" 
                                      data-toggle="modal" data-target="#modal-edit"                                      
                                      data-title="{{$menu->title}}"
                                      data-editurl="{{ route('menus-system.update', ['menu' => $menu->id])}}"
                                      data-name="{{$menu->name}}" >
...
@section('springadmins_js')
    @include('springadmins::admin.menussystem.modals.create')
    @include('springadmins::admin.menussystem.modals.delete')
    @include('springadmins::admin.menussystem.modals.edit')
    
   
    <!-- Script affter all-->
    @include('springadmins::admin.menussystem.scripts.manage')
@stop
